...
class MaterialLoadingBar : View {
    ...
    @TargetApi(Build.VERSION_CODES.JELLY_BEAN_MR1) private fun setAnimationEnabled() {
...
//        barPaint.color = barColor
        ...
        barPaint.shader = SweepGradient(width / 2f , height / 2f , intArrayOf(Color.RED , Color.YELLOW , Color.GREEN , Color.CYAN , Color.BLUE , Color.MAGENTA , Color.RED) , null)
    ...
    companion object {
        private val TAG = MaterialLoadingBar::class.java.simpleName
    }
}