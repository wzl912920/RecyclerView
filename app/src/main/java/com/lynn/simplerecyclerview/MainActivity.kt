...
class MainActivity : BaseActivity() {
    ...
    private fun simpleRecyclerDemo() {
        ...
        adapter.list.add(x)
        x = DataImg(/*"http://img1.juimg.com/170409/330818-1F40Z9160774.jpg"*/"http://thecatapi.com/api/images/get?format=src&type=jpg")
        adapter.list.add(x)
        x = DataImg(/*"http://img1.juimg.com/170630/355861-1F63012563242.jpg"*/"https://source.unsplash.com/random")
        adapter.list.add(x)
        x = DataImg(/*"http://img1.juimg.com/170715/330800-1FG50P12715.jpg"*/"https://img.xjh.me/random_img.php?type=bg&ctype=nature&return=302")
        adapter.list.add(x)
        x = DataImg(/*"http://img1.juimg.com/170802/330854-1FP2154R385.jpg"*/"http://api.dujin.org/bing/1920.php")
        adapter.list.add(x)
        x = DataImg(/*"http://img1.juimg.com/170802/330854-1FP2154R385.jpg"*/"https://picsum.photos/200/300/?random")
        adapter.list.add(x)
        x = DataImg(/*"http://img1.juimg.com/170802/330854-1FP2154R385.jpg"*/"https://picsum.photos/200/300/?random&blur")
        adapter.list.add(x)
        var n = DataNormal()
        adapter.list.add(n)
        n = DataNormal()
